    ...
    <div className="flex-1 overflow-y-auto p-12 luxury-container">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-12">
        <div className="flex flex-col gap-12">
          {pages.map((page) => (
            <div key={page.id} className="luxury-card group hover:border-[#cc785c]/30 transition-all duration-300">
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="bg-[#141413] rounded-3xl p-12 text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="mb-16">
                <h2 className="text-5xl font-light mb-6 font-serif">All systems are <span className="text-[#cc785c]">operational</span>.</h2>
                <p className="text-[#6c6a64] text-lg max-w-sm">Global infrastructure is performing within optimal parameters.</p>
              </div>
